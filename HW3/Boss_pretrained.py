...
train_encodings = tokenizerFast(train_questions, train_contexts_trunc, max_length = MAX_LENGTH,truncation=True,stride=dynamic_stride,
        padding=True)
valid_encodings = tokenizerFast(valid_questions, valid_contexts, max_length = MAX_LENGTH, truncation=True,stride=dynamic_stride,
        padding=True)
...
class QA_Lang_Model(nn.Module):
    def __init__(self):
        ...
        self.l1 = nn.Linear(1024 * 2, 1024 * 2)
        self.l2 = nn.Linear(1024 * 2, 2)

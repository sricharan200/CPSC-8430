...
train_encodings.update({'start_positions': start_loc, 'end_positions': end_loc})
valid_encodings.update({'start_positions': start_loc, 'end_positions': end_loc})
...
optim = AdamW(model.parameters(), lr=2e-5, weight_decay=2e-2)  #Adam Optimizer
